...
function Settings({ onBack }) {
    ...
    const [status, setStatus] = useState({ github_pat_set: false, gemini_api_key_set: false, gemini_project_id: '' });
    ...
    const handleSave = (e) => {
        ...
        if (geminiProjectID !== status.gemini_project_id) payload.gemini_project_id = geminiProjectID;
